...
<<<<<<< Updated upstream
  ...
  if command.lower().strip().startswith("sharpup"): check_module_loaded("SharpUp.exe", randomuri, user)
  if command.lower().strip().startswith("safetydump"): check_module_loaded("SafetyDump.exe", randomuri, user)
  if command.lower().strip().startswith("rubeus"): check_module_loaded("Rubeus.exe", randomuri, user)
  if command.lower().strip().startswith("sharpview"): check_module_loaded("SharpView.exe", randomuri, user)
  if command.lower().strip().startswith("watson"): check_module_loaded("Watson.exe", randomuri, user)
  if command.lower().strip().startswith("sharphound"): check_module_loaded("SharpHound.exe", randomuri, user)
=======
<<<<<<< Updated upstream
  if command.lower().strip().startswith("seatbelt"): check_module_loaded("Seatbelt.exe", randomuri, user)
=======
